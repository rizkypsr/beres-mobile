...
class InputId_page extends StatefulWidget {
  final int? id_detail;
  ...
  // this.listSampah});
  @override
  _InputId createState() => _InputId();
}

class _InputId extends State<InputId_page> {
  int run = 0;
          ...
          child: Center(
            child: TextField(
              ...
              decoration: InputDecoration(
                  ...
                  prefixIcon:
                      Icon(Icons.input_rounded, color: Color(0xFF0e8e83)),
                  hintText: 'User ID',
  ...
  Widget buildButton() {
    return Container(
        ...
        child: ElevatedButton(
            ...
            onPressed: () async {
              setState(() {
                controller.text.isEmpty ? _validate = true : run = 1;
              });
              if (run == 1) {
